...
async function copyRelationsForTaskIds(taskIdMap, transaction = null) {
    ...
    return await TaskRelation.bulkCreate(
        relations.map((relation) => {
            const mappedSource = taskIdMap[relation.source_task_id];
            const mappedTarget = taskIdMap[relation.target_task_id];
            ...
            const [source_task_id, target_task_id] =
                relation.relation_type === TaskRelation.TYPE.RELATED_TO
                    ? canonicalPair(mappedSource, mappedTarget)
